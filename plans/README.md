...
| `chapter-7-projects-plan.md` | **Done & deployed** | All 4 Ch7 capstones live (To-Do List Manager, Contact Book, Hangman, Word Frequency Counter — PRs #40–#42), exercising all of Basics (Ch1–6). |
| `strategy-qa-audit-plan.md` | **Proposed — awaiting teacher priorities** | Full QA audit (security/integrity, UX/a11y, copy, LMS best practices, scaling, monetisation) + 6-phase roadmap. Headline findings: client-forgeable test scores (A1), Clerk dev instance in prod (A2), thin accessibility, stale meta copy, single-tenancy as the growth blocker. Phase 0 = quick wins; Phase 1 = production/assessment hardening (recommended before next school year); Phase 5 = B2B school licensing. NOT actionable by the routine — strategic decisions belong to the teacher. |
