...
| `language-toggle-plan.md` | **Phase 2 complete — PR open** | EN/LT language toggle. Phase 1 (foundation + theory wiring) shipped. Phase 2 (all UI chrome — ~22 files, ~150 EN+LT keys via `t()`) done; lint + build green; PR `phase2-ui-i18n` open for review. Remaining = Phase 3 content translation + Phase 4 D1 persistence. |
