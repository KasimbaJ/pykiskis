...
| `language-toggle-plan.md` | **Phases 1+2 done — PR open** | EN/LT language toggle. Phase 1: foundation + header toggle + theory-content wiring. Phase 2: `i18n-ui.ts` + `useT()` hook + ~130-key EN/LT dictionary; all ~31 component/page files updated. Remaining = content wiring (Phase 3) + content translation. |
