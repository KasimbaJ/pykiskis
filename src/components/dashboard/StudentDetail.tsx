...
export default function StudentDetail({ student, onBack }: Props) {
  ...
  return (
    <div>
      ...
      >
        <ArrowLeft className="w-4 h-4" /> {t('detail.backAll', lang)}
      </button>
                    ...
                    return (
                      ...
                      >
                        ...
                        {score != null ? (
                          ...
                          <p className="text-sm text-slate-400">{t('detail.notTaken', lang)}</p>
                        )}
                      </li>
                    )
                  })}
              ...
              return (
                ...
                >
                  <span className="text-slate-700">
                    {t('detail.chapterLabel', lang, { id: ch.id, title: ch.title })}
                  </span>
                  <span className="text-slate-500 tabular-nums">{t('detail.lessons', lang, { count: total })}</span>
                </li>
              )
            })}
          </ul>
      ...
      <h3 className="text-base font-semibold text-slate-800 mb-3">{t('detail.phaseLevelsTitle', lang)}</h3>
            ...
            >
              <div className="flex items-center justify-between mb-1">
                <span className="text-xs font-semibold text-slate-500 uppercase">
                  {t('level.label', lang, { id: level.id })}
                </span>
                {isCompleted ? (
              ...
              <div className="mt-2 flex items-center justify-between text-xs text-slate-500">
                <span>{t('detail.attempts', lang, { count: progress?.attempts ?? 0 })}</span>
