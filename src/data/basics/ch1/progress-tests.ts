...
//
// Four checkpoint tests of 10 questions each, scheduled after the second,
// fourth, sixth, and eighth modules.  Each test mixes three question types:
//   • mcq             — multiple-choice
//   • predict-output  — read a snippet, type the exact output
//   • fill-in-blank   — single short answer
//
// Suggested passing score is 7/10 but progression is NOT gated on it.
// Learners can retake any test unlimited times; the best score is kept.
// ─────────────────────────────────────────────────────────────────────────────

// ── Test 1: after Numbers and Strings ────────────────────────────────────────
  ...
  lessons: [
    {
      ...
      questions: [
        ...
        },
        {
          ...
          explanation: 'The assignment operator in Python is `=` (a single equals sign).',
        },
        {
          id: 'q8',
          qType: 'mcq',
...
// ── Test 3: after Arithmetic Operators ───────────────────────────────────────
